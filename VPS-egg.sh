...
echo "#######################################################################################"
echo "#"
echo "#                                  SoulNodes.fr.nf PteroVM"
echo "#"
echo "#                           Copyright (C) 2022 - 2024, SoulNodes.fr.nf"
echo "#"
echo "#"
echo "#######################################################################################"
echo ""
...
display_header() {
    echo -e "${BOLD_MAGENTA}__________________________________________________"
    echo -e "           ${YELLOW}-----> System Resources Info <----${RESET_COLOR}"
    echo -e ""
}
...
display_resources() {
    ...
    echo -e " Host -> ${BOLD_GREEN}SoulNode${RESET_COLOR}"
}
